...
deployedContracts['SafeMath'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['SafeMath']].interface)).at('0xbF1B82D92c222384C60AcEcAE4FeE2C066a77A50');
deployedContracts['LiquidRE'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['LiquidRE']].interface)).at('0x034E281F61045D52B05192D1d323Cc99Bf4eAd03');
deployedContracts['BancorFormula'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['BancorFormula']].interface)).at('0xbd10f5cbd027e861363c70d23cd541322553215e');
deployedContracts['LiquidREPointer'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['LiquidREPointer']].interface)).at('0x45702245563e29cfe1ee2a40bfcb6afae3202ab9');
deployedContracts['LRETLogic'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['LRETLogic']].interface)).at('0xA7464dC64863E344846A37676EeeB02BC3078Bac');
deployedContracts['LiquidFactory'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['LiquidFactory']].interface)).at('0x06885c740255b7625C0b244289877006A489D3d4');
deployedContracts['ConverterLogic'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['ConverterLogic']].interface)).at('0x2bceb7b662c645587be091755e708866e52b2555');
deployedContracts['IREOLogic'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['IREOLogic']].interface)).at('0x33ceebe9c8085108b683437f233f3392ebaece7c');
deployedContracts['TPEG'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['TPEG']].interface)).at('0x98faad053622c52f678354111dd7fa13d0cce489');
deployedContracts['RENT'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['RENT']].interface)).at('0x966eC9490F78f7873631523b512E6A6f161ad709');
deployedContracts['RENTLogic'] = web3.eth.contract(JSON.parse(output.contracts[contractNameKeys['RENTLogic']].interface)).at('0x9EF96EA4cc96198dA5e43A41fa70a92731237A3f');
